...
👋│اهلا بك في سورس ديو 😍
●ـ▬ـ▬ஜ۩۞۩ஜ▬ـ▬ـ●
🤖│[تنصيب بوتات](t.me/LeDew1)
👨🏻‍✈️╽[مطور السـورس](t.me/LeDew1)
●ـ▬ــ▬ஜ۩۞۩ஜ▬ـ▬ـ●
...
³↫ ❬وارسل تفعيل وسيتم تفعيل البوت ورفع مشرفي القروب تلقائين ❭ 🔱
...
"هلا بمطوري الحب أمرني"}
local ss97 = {
"هلا حياتي😻","عيونه 👀 وخشمه 👃🏻واذنه👂🏻",
"تبي اجلدك؟ 😎","ها حبي 😍","ها عمري","ها شتبي رديت 🌚??",
"هلا بعشقي 🌚❤️","نعم حبي ","شوفو له حل ازعجني المريض 😷",
"خلصني بسرعه شتبي😤","ها يا قلبي ❤️","ماتستك انت ترا بغير اسمي بسببك😡",
"لك فداك ["..Bot_Name.."] حبيبي انت اموووح 💋","اشرب شاي مب فاضي لك😌","قول حبيبي أمرني 😍",
"خلصني قول لااقلب عليك القروب كله 😒😏",
"اشغلت اهل ["..Bot_Name.."] شتبي 😠","بووووووووو 👻 ها ها فزيت شفتك شفتك لا تحلف 😂",
"طالع مب موجود 😒","القمر ناداني؟😍💕","انت مو قبل يومين غلطت علي؟  😒",
"كل يوم افشلك ماتتوب انت؟ 😑😹","ياعيون ["..Bot_Name.."] أمرني 😍",
"ماعندك حياة انت؟ بس فاضي تنادي","سويت اشيا واجد في حياتي لاكن ولا مرا قلت حق احد انجب 😑",
"مشغول مع الحب  ☺️","مازا تريد مني 😌🍃"
}
local bs = {
"مابوس 🌚💔",
"امووحح❤️",
...
local dr = {
"الله معاك والتكسي على حسابي 😂😂 ",
"اذللللف",
}
local nnn = {
"اسمي ["..Bot_Name.."] 😌",
"شتبي كل شوي كاتب بوت😒",
"اذا عدتها بفنشك بالطاوه😠",
"انجب انت البوت😂",
}
local lovm = {
"اكرهك 😒👌🏿",
...
elseif Text== "عبدالله" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/LeDew1")
elseif Text== "حسن العراقي" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس  😍](t.me/LeDew1")
elseif Text== "تمام" then return sendMsg(msg.chat_id_,msg.id_,"دوم بخير حياتي 😘")
...
elseif Text== "😢"  then return sendMsg(msg.chat_id_,msg.id_,"لاتصيح حياتي 😢")
elseif Text== "😭"  then return sendMsg(msg.chat_id_,msg.id_,"لاتصيح حياتي 😭😭")
